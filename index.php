		...
		<div class="row">
			<div class="col-sm-6 col-md-6">
				<div class="card">
					<div class="card-content">
						<p>
							<center><a href="/details"><i class="fa fa-ticket" style="font-size: 1000%"></i></a></center>
						</p>
					</div>
				</div>
			</div>
			<div class="col-sm-6 col-md-6">
				<div class="card">
					<div class="card-content">
						<p>
							<center><a href="/reports"><i class="fa fa-paperclip" style="font-size: 1000%;"></i></a></center>
						</p>
					</div>
				</div>
			</div>
